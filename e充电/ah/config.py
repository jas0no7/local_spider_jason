...
# kafka topic
KAFKA_TOPIC = "spider-charge"
# mysql数据库表名
DB_BASIC = "root_ah_charge_basic"  # 充电桩基础信息表
DB_DETAIL = "root_ah_charge_detail"  # 充电桩详情
DB_TERMINAL = "root_ah_charge_terminal"  # 充电桩终端功率
DB_ORIGIN_PRICE = "root_ah_charge_origin_price"  # 充电桩当天价格
# DB_NUMBER = "root_cq_charge_num"  # 每批次和客户的匹配数据量
# 特来电token
REDIS_TLD_X_TOKEN = "variable:charge_cq:tld_token"
# 龙禹快充token
REDIS_LYKC_TOKEN = "variable:charge_cq:lykc_token"
# 去重
REDIS_DUPLICATE = "duplicate:charge_ah"
# 不是重庆的站点
REDIS_FILTER = "duplicate:charge_ah_no"
# 超时
TIMEOUT = 5
# 重试
RETRY = 8
