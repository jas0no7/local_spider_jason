...
class DataSpider(CrawlSpider):
    name = 'policy_snsfzggw'
    allowed_domains = [
        'sfzggw.suining.gov.cn'
    ]
    ...
    infoes = [
        {
            'url': 'https://sfzggw.suining.gov.cn/xinwen/list/57484cce7cdbfb39636d22f1ae231258.html',
            'label': "公示公告",
            'detail_xpath': '//ul[@class="content-list"]/li',
            'url_xpath': './a/@href',
            'title_xpath': './a/@title',
            'publish_time_xpath': './span/text()',
            'body_xpath': '//div[@class="xqing-web-box"]',
            'total': 11,
            'page': 1,
            'base_url': 'https://sfzggw.suining.gov.cn/xinwen/list/57484cce7cdbfb39636d22f1ae231258.html?page={}'
        },
        {
            'url': 'https://sfzggw.suining.gov.cn/xinwen/list/d96d00d3ec9c7d41dfcc53b46b54cb54.html',
            'label': "规划信息",
            'detail_xpath': '//ul[@class="content-list"]/li',
            'url_xpath': './a/@href',
            'title_xpath': './a/@title',
            ...
            'total': 12,
            'page': 1,
            'base_url': 'https://sfzggw.suining.gov.cn/xinwen/list/d96d00d3ec9c7d41dfcc53b46b54cb54.html?page={}'
        }
    ]
