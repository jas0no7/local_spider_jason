...
class DataSpider(CrawlSpider):
    ...
    infoes = [
        {
            'url': 'https://www.neijiang.gov.cn/fgw/xxgk/fdzdgknr/qtfdxx/gsgg/zfxxgk_gknrz.shtml',
            'label': "公示公告",
            'detail_xpath': '//div[@id="wzlm"]//dd',
            'url_xpath': './a/@href',
            'title_xpath': './a/@title',
            'publish_time_xpath': './span/text()',
            'body_xpath': '//div[@class="gknbxq_detail"]',
            'total': 4,
            'page': 1,
            'base_url': 'https://www.neijiang.gov.cn/fgw/xxgk/fdzdgknr/qtfdxx/gsgg/zfxxgk_gknrz_{}.shtml'
        },
        {
            'url': 'https://www.neijiang.gov.cn/fgw/xxgk/fdzdgknr/ghjh/ghxx/zfxxgk_gknrz.shtml',
            'label': "规划信息",
            'detail_xpath': '//div[@id="wzlm"]//dd',
            'url_xpath': './a/@href',
            'title_xpath': './a/@title',
            ...
            'total': 1,
            'page': 1,
            'base_url': 'https://www.neijiang.gov.cn/fgw/xxgk/fdzdgknr/ghjh/ghxx/zfxxgk_gknrz_{}.shtml'
        }
    ]
