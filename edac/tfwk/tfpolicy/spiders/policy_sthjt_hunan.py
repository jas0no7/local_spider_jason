...
class DataSpider(CrawlSpider):
    ...
    infoes = [
        {
            'url': 'https://sthjt.hunan.gov.cn/sthjt/xxgk/ghcw/ghjh/index.html',
            'label': "规划计划",
            'detail_xpath': '//div[@class="hy-list-text"]/ul/li/a',
            'url_xpath': './@href',
            'title_xpath': './@title',
            'publish_time_xpath': './small',
            'body_xpath': '//div[@class="main_content"]',
            'total': 3,
            'page': 1,
            'base_url': 'https://sthjt.hunan.gov.cn/sthjt/xxgk/ghcw/ghjh/index_{}.html'
        },
        {
            'url': 'https://sthjt.hunan.gov.cn/sthjt/xxgk/zcfg/zcfgjd/list_sy3.html',
            'label': "政策解读",
            'detail_xpath': '//div[@class="hy-list-text"]/ul/li/a',
            'url_xpath': './@href',
            'title_xpath': './@title',
            ...
            'total': 5,
            'page': 1,
            'base_url': 'https://sthjt.hunan.gov.cn/sthjt/xxgk/zcfg/zcfgjd/list_sy3_{}.html'
        },
        {
            'url': 'https://sthjt.hunan.gov.cn/sthjt/xxgk/zcfg/gfxwj/list_sy3.html',
            'label': "地方性法规、政府规章、地方标准和规范性文件",
            'detail_xpath': '//div[@class="hy-list-text"]/ul/li/a',
            'url_xpath': './@href',
            'title_xpath': './@title',
            'publish_time_xpath': './small',
            ...
            'total': 3,
            'page': 1,
            'base_url': 'https://sthjt.hunan.gov.cn/sthjt/xxgk/zcfg/gfxwj/list_sy3_{}.html'
        },
    ]
