...
class DataSpider(CrawlSpider):
    ...
    infoes = [
        {
            'url': 'https://sndrc.shaanxi.gov.cn/zjww/wsdw/sxsnyj/news/zctz/index.html',
            'label': "政策通知",
            'detail_xpath': '//li[@class="clearfix"]',
            'url_xpath': './a/@href',
            'title_xpath': './a/@title',
            ...
            'total': 6,
            'page': 1,
            'base_url': 'https://sndrc.shaanxi.gov.cn/zjww/wsdw/sxsnyj/news/zctz/index_{}.html'
        }
