...
class DataSpider(CrawlSpider):
    ...
    infoes = [
        {
            'url': 'https://fjb.nea.gov.cn/dtyw/hyxx/index.html',
            'label': "行业信息",
            'detail_xpath': '//div[@class="wrapper_overview_right_list"]/ul/li/a',
            'url_xpath': './@href',
            'title_xpath': './span[1]/text()',
            'publish_time_xpath': './span[2]/text()',
            'body_xpath': '//div[@class="channel-page"] | //div[@class="wrapper_deatil"]',
            'total': 208,
            'page': 1,
            'base_url': 'https://fjb.nea.gov.cn/dtyw/hyxx/index_{}.html'
        },
    ...
    def parse_detail(self, response):
        ...
        yield DataItem({
            ...
            'spider_topic': "spider-tfpolicy-news-sthjt-fujian-v1"
        })
