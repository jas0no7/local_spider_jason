...
class DataSpider(CrawlSpider):
    ...
    infoes = [
        {
            'url': 'http://sfgw.ziyang.gov.cn/Catalog/?page=1&id=1',
            'label': "公告",
            'detail_xpath': '//table[@class="td14-2"]/tbody/tr',
            'url_xpath': './td[@class="xia2"][2]/div[@class="content_title"]/a/@href',
            'title_xpath': './td[@class="xia2"][2]/div[@class="content_title"]/a/text()',
            'publish_time_xpath': 'substring(./td[@class="xia2"][3]/span/text(),2,11)',
            'body_xpath': '//div[@class="t_content"]',
            'total': 19,
            'page': 1,
            'base_url': 'http://sfgw.ziyang.gov.cn/Catalog/?page={}&id=1'
        },
    ]
