...
class DataSpider(CrawlSpider):
    ...
    infoes = [
        {
            'url': 'https://kjt.sc.gov.cn/kjt/xzgfxwj/newschild.shtml',
            'label': "首页;政府信息公开;政策法规;行政规范性文件",
            'detail_xpath': '//div[@class="column-list"]/ul/li',
            'url_xpath': './a/@href',
            'title_xpath': './a/@title',
            ...
            'total': 2,
            'page': 1,
            'base_url': 'https://kjt.sc.gov.cn/kjt/xzgfxwj/newschild_{}.shtml'
        },
        {
            'url': 'https://kjt.sc.gov.cn/kjt/qtwj/newschild.shtml',
            ...
            'total': 1,
            'page': 1,
            'base_url': 'https://kjt.sc.gov.cn/kjt/qtwj/newschild_{}.shtml'
        },
        {
            'url': 'https://kjt.sc.gov.cn/kjt/zcjd2023/newschild.shtml',
            'label': "首页;政务公开;政策解读",
            'detail_xpath': '//div[@class="column-list"]/ul/li',
            'url_xpath': './a/@href',
            'title_xpath': './a/@title',
            ...
            'total': 2,
            'page': 1,
            'base_url': 'https://kjt.sc.gov.cn/kjt/zcjd2023/newschild_{}.shtml'
        }
    ]
    ...
    def parse_detail(self, response):
        ...
        author = response.xpath('//meta[@name="Author"]/@content').extract_first() or \
                 ''.join(re.findall(r'发布机构：</strong><span>(.*?)</span></li>', response.text, re.DOTALL)).strip()
