...
class DataSpider(CrawlSpider):
    ...
    infoes = [
        {
            'url': 'https://www.longquanyi.gov.cn/gkml/xzgfxwj/column-index-1.shtml',
            'label': "政策;行政法规文件",
            ...
            'total': 2,
            'page': 1,
            'base_url': 'https://www.longquanyi.gov.cn/gkml/xzgfxwj/column-index-{}.shtml?page={}'
        },
        {
            'url': 'https://www.longquanyi.gov.cn/gkml/qtwj/qtwj/column-index-1.shtml',
            'label': "政策;其他文件",
            'detail_xpath': '//div[@class="li"]',
            'url_xpath': './@onclick',
            'title_xpath': './span[@class="s2"]/text()',
            ...
            'total': 6,
            'page': 1,
            'base_url': 'https://www.longquanyi.gov.cn/gkml/qtwj/qtwj/column-index-{}.shtml?page={}'
        }
    ]
