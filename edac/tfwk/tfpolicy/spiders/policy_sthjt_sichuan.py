...
class DataSpider(CrawlSpider):
    ...
    infoes = [
        {
            'url': 'https://sthjt.sc.gov.cn/sthjt/c23101804/newzcjd.shtml',
            'label': "政策解读",
            'detail_xpath': '//div[@class="p_ty_list"]/ul/li',
            'url_xpath': './a/@href',
            'title_xpath': './a/@title',
            'publish_time_xpath': './span[1]',
            'body_xpath': '//div[@class="xl_cont"]',
            'total': 6,
            'page': 1,
            'base_url': 'https://sthjt.sc.gov.cn/sthjt/c23101804/newzcjd_{}.shtml'
        },
        {
            'url': 'https://sthjt.sc.gov.cn/sthjt/c23101801/xzgfxwj.shtml',
            'label': "行政规范文件",
            'detail_xpath': '//div[@class="biaobody"]/ul/li',
            'url_xpath': './div[@class="lie2 skipAutoFix"]/a/@href',
            'title_xpath': './div[@class="lie2 skipAutoFix"]/a/@title',
            'publish_time_xpath': './div[@class="lie5"]',
            'body_xpath': '//div[@class="zc-detail"]',
            'total': 2,
            'page': 1,
    ...
    def parse_detail(self, response):
        ...
        yield DataItem({
            ...
            'spider_topic': "spider-policy-sichuan"
        })
