...
class DataSpider(CrawlSpider):
    name = 'policy_lszfzggw'
    allowed_domains = [
        'fgw.lsz.gov.cn'
    ]

    _from = '凉山彝族自治州发展和改革委员会'
    dupefilter_field = {
        "batch": "20241111"
    }
    use_playwright = True
    ...
    infoes = [
        {
            'url': 'https://fgw.lsz.gov.cn/zfxxgk/zc/zcjd_31882/',
            'label': "政策解读",
            'detail_xpath': '//ul[@class="list"]/li',
            'url_xpath': './a/@href',
            'title_xpath': './a/@title',
            'publish_time_xpath': './span/text()',
            'body_xpath': '//div[@id="font-s"]',
            'total': 4,
            'page': 0,
            'base_url': 'https://fgw.lsz.gov.cn/zfxxgk/zc/zcjd_31882/index_{}.html'
        },
        {
            'url': 'https://fgw.lsz.gov.cn/zfxxgk/zc/zcwj_31881/',
            'label': "政策文件",
            'detail_xpath': '//ul[@class="list"]/li',
            'url_xpath': './a/@href',
            'title_xpath': './a/@title',
            ...
            'total': 10,
            'page': 0,
            'base_url': 'https://fgw.lsz.gov.cn/zfxxgk/zc/zcwj_31881/index_{}.html'
        }
    ]
