...
class DataSpider(CrawlSpider):
    ...
    infoes = [
        {
            'url': 'https://scb.nea.gov.cn/xxgk/flfg/index_1.html',
            'label': "政策法规",
            'detail_xpath': '//ul [@class="wrapper_item_con4_ul"]/li/a',
            'url_xpath': './@href',
            'title_xpath': './span[1]/text()',
            'publish_time_xpath': './span[2]',
            'body_xpath': '//div[@class="article_l"] | //div[@class="wrapper_detail_text"] | //div[@class="article-box"]',
            'total': 2,
            'page': 1,
            'base_url': 'https://scb.nea.gov.cn/xxgk/flfg/index_{}.html'
        },
        {
            'url': 'https://scb.nea.gov.cn/xxgk/zcjd/index.html',
            'label': "政策解读",
            'detail_xpath': '//ul [@class="wrapper_item_con4_ul"]/li/a',
            'url_xpath': './@href',
            'title_xpath': './span[1]/text()',
