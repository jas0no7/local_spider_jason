...
class DataSpider(CrawlSpider):
    ...
    infoes = [
        {
            'url': 'http://fgw.panzhihua.gov.cn/zwgk/zcfg/zcwj/index.shtml',
            'label': "首页;政务公开;政策法规;政策文件",
            'detail_xpath': '//div[@class="new-box"]/ul/li',
            'url_xpath': './a/@href',
            'title_xpath': './a/@title',
            'publish_time_xpath': './span/text()',
            'body_xpath': '//div[@id="Zoom" or @class="info_right"]',
            'total': 2,
            'page': 1,
            'base_url': 'http://fgw.panzhihua.gov.cn/zwgk/zcfg/zcwj/index_{}.shtml'
        },
        {
            'url': 'http://fgw.panzhihua.gov.cn/zwgk/zcfg/zcjd/index.shtml',
            ...
            'total': 2,
            'page': 1,
            'base_url': 'http://fgw.panzhihua.gov.cn/zwgk/zcfg/zcjd/index_{}.shtml'
        }
    ]
