...
class DataSpider(CrawlSpider):
    name = 'policy_abzfzggw'
    allowed_domains = [
        'fgw.abazhou.gov.cn'
    ]

    _from = '阿坝藏族羌族自治州发展和改革委员会'
    dupefilter_field = {
        "batch": "20241111"
    }
    use_playwright = True
    ...
    infoes = [
        {
            'url': 'https://fgw.abazhou.gov.cn/abzfzggw/c105307/common_list.shtml',
            'label': "首页;政务公开;依法行政;政策解读",
            'detail_xpath': '//ul[@class="list-li"]/li/a',
            'url_xpath': './@href',
            'title_xpath': './p/text()',
            ...
            'total': 2,
            'page': 1,
            'base_url': 'https://fgw.abazhou.gov.cn/abzfzggw/c105307/common_list_{}.shtml'
        },
        {
            'url': 'https://fgw.abazhou.gov.cn/abzfzggw/c105308/common_list.shtml',
            'label': "首页;政务公开;依法行政;政策文件",
            'detail_xpath': '//ul[@class="list-li"]/li/a',
            'url_xpath': './@href',
            'title_xpath': './p/text()',
            'publish_time_xpath': './span/text()',
            ...
            'total': 2,
            'page': 1,
            'base_url': 'https://fgw.abazhou.gov.cn/abzfzggw/c105308/common_list_{}.shtml'
        }
    ]
    ...
    def parse_detail(self, response):
        ...
        author = response.xpath('//meta[@name="Author"]/@content').extract_first() or \
                 response.xpath('//meta[@name="ContentSource"]/@content').extract_first() or \
