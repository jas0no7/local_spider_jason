...
class DataSpider(CrawlSpider):
    ...
    infoes = [
        {
            'url': 'https://sthjt.shaanxi.gov.cn/xxgk/xwfb/index.html',
            'label': "政策通知",
            ...
            'total': 6,
            'page': 1,
            'base_url': 'https://sthjt.shaanxi.gov.cn/xxgk/xwfb/index_{}.html'
        }
    ...
    def parse_detail(self, response):
        ...
        yield DataItem({
            ...
            'spider_topic': "spider-news-shaanxi"
        })
