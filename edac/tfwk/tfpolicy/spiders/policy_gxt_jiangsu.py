    ...
    infoes = [
        {
            ...
            'label': "统计信息",
            'detail_xpath': '//div[@class="default_pgContainer"]/ul/li/a',
            'url_xpath': './@href',
            'title_xpath': './@title',
            'publish_time_xpath': './b[@readlabel]/text()',
            'body_xpath': '//div[@class="scroll_cont ScrollStyle"]',
            'total': 9,
            'page': 1,
