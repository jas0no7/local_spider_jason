...
class DataSpider(CrawlSpider):
    ...
    infoes = [
        {
            'url': 'https://drc.cngy.gov.cn/New/List/20190117104419698.html',
            'label': "首页;信息公开;基本信息公开;政策文件",
            'detail_xpath': '//div[@class="id-list"]/ul/li',
            'url_xpath': './a/@href',
            'title_xpath': '',
            'publish_time_xpath': './span/text()',
            'body_xpath': '//div[@class="page-content-text"]',
            'total': 10,
            'page': 1,
            'base_url': 'https://drc.cngy.gov.cn/New/List/20190117104419698.html?page={}'
        },
        {
            'url': 'https://drc.cngy.gov.cn/new/list/20190117111432773.html',
            'label': "首页;解读回应;政策解读",
            'detail_xpath': '//div[@class="id-list"]/ul/li',
            'url_xpath': './a/@href',
            'title_xpath': '',
            ...
            'total': 7,
            'page': 1,
            'base_url': 'https://drc.cngy.gov.cn/New/List/20190117111432773.html?page={}'
        }
    ]
