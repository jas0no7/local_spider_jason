...
class DataSpider(CrawlSpider):
    ...
    infoes = [
        {
            'url': 'https://czt.sc.gov.cn/scczt/xzgfxwj/gfxwj_list.shtml',
            'label': "首页;政策;行政规范性文件",
            ...
            'total': 7,
            'page': 1,
            'base_url': 'https://czt.sc.gov.cn/scczt/xzgfxwj/gfxwj_list_{}.shtml'
        },
        {
            'url': 'https://czt.sc.gov.cn/scczt/qtwj/gfxwj_list.shtml',
            'label': "首页;政策;其他文件",
            'detail_xpath': '//div[@class="biaobody"]/ul/li/div[@class="lie2"]',
            'url_xpath': './a/@href',
            'title_xpath': './a/@title',
            ...
            'total': 22,
            'page': 1,
            'base_url': 'https://czt.sc.gov.cn/scczt/qtwj/gfxwj_list_{}.shtml'
        },
        {
            'url': 'https://czt.sc.gov.cn/scczt/zcjd/zfxxgk_gknrz.shtml',
            'label': "首页;政策解读",
            'detail_xpath': '//div[@id="wzlm"]//dd',
            'url_xpath': './a/@href',
            'title_xpath': './a/@title',
            'publish_time_xpath': './span/text()',
            'body_xpath': '//div[@id="NewsContent"]',
            'total': 6,
            'page': 1,
            'base_url': 'https://czt.sc.gov.cn/scczt/zcjd/zfxxgk_gknrz_{}.shtml'
        }
    ]
    ...
    def parse_detail(self, response):
        ...
        author = response.xpath('//meta[@name="Author"]/@content').extract_first() or \
            ...
            response.xpath('//div[@class="wz_name"]/text()').extract_first()
