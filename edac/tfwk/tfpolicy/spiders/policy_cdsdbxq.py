...
class DataSpider(CrawlSpider):
    ...
    infoes = [
        {
            'url': 'http://dbxq.chengdu.gov.cn/gkml/xzgfxwj/column-index-1.shtml',
            'label': "首页;政务公开;政府信息公开专栏;政策;行政规范性文件",
            ...
            'total': 2,
            'page': 1,
            'base_url': 'http://dbxq.chengdu.gov.cn/gkml/xzgfxwj/column-index-{}.shtml?page={}'
        },
        {
            'url': 'http://dbxq.chengdu.gov.cn/gkml/qtwj/qtwj/column-index-1.shtml',
            'label': "首页;政务公开;政府信息公开专栏;政策;其他文件",
            'detail_xpath': '//div[@class="li"]',
            'url_xpath': './@onclick',
            'title_xpath': './span[@class="s2"]/text()',
            'publish_time_xpath': '',
            ...
            'total': 3,
            'page': 1,
            'base_url': 'http://dbxq.chengdu.gov.cn/gkml/qtwj/qtwj/column-index-{}.shtml?page={}'
        }
    ]

    infoes_ajax = [
        {
            'url': 'https://dbxq.chengdu.gov.cn/es-search/search/f890e64646824bff8c4dd51ee3bf0ffb?_template=ucap/cdtf&_pageSize={}&page={}',
            'label': "首页;政务公开;基本信息公开;政策文件及解读;政策文件;本级政策文件",
            'body_xpath': '//div[@id="content" or @id="glxx"]',
            'page': 1,
        },
        {
            'url': 'https://dbxq.chengdu.gov.cn/es-search/search/d7d2b5f833e840448e5f5358e7da0c23?_template=ucap/cdtf&_pageSize={}&page={}',
            'label': "首页;政务公开;基本信息公开;政策文件及解读;行政规范性文件;现行有效",
            'body_xpath': '//div[@id="content" or @id="glxx"]',
            'page': 1,
        },
        {
            'url': 'https://dbxq.chengdu.gov.cn/es-search/search/31d9a7b85abe493d8e49dab028c9eb96?_template=ucap/cdtf&_pageSize={}&page={}',
            'label': "首页;政务公开;基本信息公开;政策文件及解读;行政规范性文件;现行有效",
            'body_xpath': '//div[@id="content" or @id="glxx"]',
            'page': 1,
        }
    ...
    def start_requests(self):
        ...
        for info in self.infoes_ajax:
            ...
            url = info.get('url')
            yield scrapy.Request(
                url=url.format(self.page_size, 1),
        ...
        try:
            ...
            for data in datas:
                ...
                meta = {
                    ...
                    'publish_time': data.get('publishedTimeStr'),
                    'body_xpath': body_xpath,
                    "use_playwright": self.use_playwright
                }
                yield scrapy.Request(
            ...
            if self.page_size * page < total:
                page += 1
                yield scrapy.Request(
                    url=start_url.format(self.page_size, page),
                    callback=self.parse_item_ajax,
                    meta=copy.deepcopy({
                        'label': label,
                        'body_xpath': body_xpath,
