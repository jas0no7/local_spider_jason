...
class DataSpider(CrawlSpider):
    ...
    infoes = [
        {
            'url': 'http://www.sass.cn/109010/default.aspx',
            'label': "理论研究;政策解读",
            'detail_xpath': '//ul/li',
            'url_xpath': './a/@href',
            'title_xpath': './a/text()',
            'publish_time_xpath': './a/@time',
            'body_xpath': '//body/div/p',
            'total': 42,
            'page': 1,
            'base_url': 'http://www.sass.cn/109010/{}/default.aspx'
        },
        {
            'url': 'http://www.sass.cn/129001/default.aspx',
            'label': '政策;工作制度管理办法',
            'detail_xpath': '//ul/li',
            'url_xpath': './a/@href',
            'title_xpath': './a/text()',
            ...
            'total': 3,
            'page': 1,
            'base_url': 'http://www.sass.cn/129001/{}/default.aspx'
        }
    ]
    ...
    def parse_detail(self, response):
        ...
        publish_time = _meta.get('publish_time') or \
            response.xpath('//h4/text()').extract_first()
