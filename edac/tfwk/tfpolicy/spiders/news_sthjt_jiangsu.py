...
class DataSpider(CrawlSpider):
    name = 'news_sthjt_henan'
    allowed_domains = [
        'sthjt.jiangsu.gov.cn'
    ]
    ...
    infoes = [
        {
            'url': 'https://sthjt.jiangsu.gov.cn/col/col84025/index.html?uid=402134&pageNum=1',
            'label': "省内新闻",
            'detail_xpath': '//div[@class="default_pgContainer"]/ul/li',
            'url_xpath': './a/@href',
            'title_xpath': './a/@title',
            'publish_time_xpath': './span/text()',
            'body_xpath': '//div[@class="main-con"]',
            'total': 686,
            'page': 1,
            'base_url': 'https://sthjt.jiangsu.gov.cn/col/col84025/index.html?uid=402134&pageNum={}'
        },
