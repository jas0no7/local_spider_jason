...
class DataSpider(CrawlSpider):
    ...
    infoes = [
        {
            'url': 'https://fg.yibin.gov.cn/gkgs/wsgs/',
            'label': "网上公示",
            'detail_xpath': '//table/tbody/tr/td[2]/table[3]/tbody/tr',
            'url_xpath': './td[1]/a/@href',
            'title_xpath': './td[1]/a/@title',
            'publish_time_xpath': './td[2]/span/text()',
            'body_xpath': '//span[@class="STYLE18"]',
            'total': 26,
            'page': 0,
            'base_url': 'https://fg.yibin.gov.cn/gkgs/wsgs/index_{}.html'
        }
    ]
