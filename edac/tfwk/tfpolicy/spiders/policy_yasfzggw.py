...
class DataSpider(CrawlSpider):
    ...
    infoes = [
        {
            'url': 'https://www.yaan.gov.cn/gongkai/kuozhan/10297.html',
            'label': "发展规划",
            'detail_xpath': '//ul[@class="content-list"]/li',
            'url_xpath': './a/@href',
            'title_xpath': './a/@title',
            'publish_time_xpath': './span/text()',
            'body_xpath': '//div[@class="_srcoll"]',
            'total': 1,
            'page': 1,
            'base_url': ''
        },
        {
            'url': 'https://www.yaan.gov.cn/gongkai/kuozhan/10298.html',
            'label': "空间规划",
            'detail_xpath': '//ul[@class="content-list"]/li',
            'url_xpath': './a/@href',
            'title_xpath': './a/@title',
            ...
            'total': 2,
            'page': 1,
            'base_url': 'https://www.yaan.gov.cn/gongkai/kuozhan/10298.html?page={}'
        },
        {
            'url': 'https://www.yaan.gov.cn/gongkai/kuozhan/10299.html',
            'label': "区域规划",
            'detail_xpath': '//ul[@class="content-list"]/li',
            'url_xpath': './a/@href',
            'title_xpath': './a/@title',
        ...
        {
            'url': 'https://www.yaan.gov.cn/gongkai/kuozhan/10300.html',
            'label': "专项规划",
            'detail_xpath': '//ul[@class="content-list"]/li',
            'url_xpath': './a/@href',
            'title_xpath': './a/@title',
            ...
            'total': 3,
            'page': 1,
            'base_url': 'https://www.yaan.gov.cn/gongkai/kuozhan/10300.html?page={}'
        },
        {
            'url': 'https://www.yaan.gov.cn/gongkai/kuozhan/10301.html',
            'label': "其他",
            'detail_xpath': '//ul[@class="content-list"]/li',
            'url_xpath': './a/@href',
            'title_xpath': './a/@title',
            ...
            'total': 2,
            'page': 1,
            'base_url': 'https://www.yaan.gov.cn/gongkai/kuozhan/10301.html?page={}'
        }
    ]

    def start_requests(self):
        return super().start_requests()  # 调用父类以保持兼容性
