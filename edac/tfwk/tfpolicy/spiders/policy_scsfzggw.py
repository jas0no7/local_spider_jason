...
class DataSpider(CrawlSpider):
    ...
    infoes = [
        {
            'url': 'https://fgw.sc.gov.cn/sfgw/tzgg/list.shtml',
            'label': "首页;基本信息公开;通知公告",
            'detail_xpath': '//ul[contains(@class, "list-li")]/li//h1[@class="f-20"]',
            'url_xpath': './/a/@href',
            'title_xpath': './/a/@title',
            'publish_time_xpath': './span/text()',
            'body_xpath': '//*[@id="NewsContent"]',
            'total': 67,
            'page': 1,
            'base_url': 'https://fgw.sc.gov.cn/sfgw/tzgg/list_{}.shtml'
        },
        {
            'url': 'https://fgw.sc.gov.cn/sfgw/zcwj/list.shtml',
            'label': "首页;基本信息公开;政策文件",
            'detail_xpath': '//ul[contains(@class, "list-li")]/li//h1[@class="f-20"]',
            'url_xpath': './/a/@href',
            'title_xpath': './/a/@title',
            'publish_time_xpath': './span/text()',
            ...
            'total': 40,
            'page': 1,
            'base_url': 'https://fgw.sc.gov.cn/sfgw/zcwj/list_{}.shtml'
        },
        {
            'url': 'https://fgw.sc.gov.cn/sfgw/zcjd/list.shtml',
            'label': "首页;基本信息公开;政策解读",
            'detail_xpath': '//ul[contains(@class, "list-li")]/li//h1[@class="f-20"]',
            'url_xpath': './/a/@href',
            'title_xpath': './/a/@title',
            'publish_time_xpath': './span/text()',
            ...
            'total': 5,
            'page': 1,
            'base_url': 'https://fgw.sc.gov.cn/sfgw/zcjd/list_{}.shtml'
        }
    ]
