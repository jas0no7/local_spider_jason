...
class DataSpider(CrawlSpider):
    ...
    infoes = [
        {
            'url': 'http://www.shuangliu.gov.cn/slqzfmhwz/c123876/zwgk_jiekou_childlist.shtml?classId=1588371990657957890&pageNum=1',
            'label': "首页;政务公开;法规公文;文件",
            'detail_xpath': '//table[@id="Infolist"]//tr',
            'url_xpath': './th/a/@href',
            'title_xpath': './a/text()',
            'publish_time_xpath': './td/text()',
            'body_xpath': '//div[@class="content"]',
            'total': 36,
            'page': 1,
            'base_url': 'http://www.shuangliu.gov.cn/slqzfmhwz/c123876/zwgk_jiekou_childlist.shtml?classId=1588371990657957890&pageNum={}'
        },
        {
            'url': 'http://www.shuangliu.gov.cn/slqzfmhwz/c123877/zwgk_jiekou_childlist.shtml?classId=1583411220128514049&pageNum=1',
            'label': "首页;政务公开;法规公文;政策解读",
            'detail_xpath': '//table[@id="Infolist"]//tr',
            'url_xpath': './th/a/@href',
            'title_xpath': './a/text()',
            'publish_time_xpath': './td/text()',
            ...
            'total': 13,
            'page': 1,
            'base_url': 'http://www.shuangliu.gov.cn/slqzfmhwz/c123877/zwgk_jiekou_childlist.shtml?classId=1583411220128514049&pageNum={}'
        },
        {
            'url': 'http://www.shuangliu.gov.cn/slqzfmhwz/c146717/zwgk_jiekou_list.shtml?classId=1580116519959474177&pageNum=1',
            'label': "首页;政务公开;法规公文;规范性文件",
            'detail_xpath': '//table[@id="Infolist"]//tr',
            'url_xpath': './th/a/@href',
            'title_xpath': './a/text()',
            'publish_time_xpath': './td/text()',
            ...
            'total': 3,
            'page': 1,
            'base_url': 'http://www.shuangliu.gov.cn/slqzfmhwz/c146717/zwgk_jiekou_list.shtml?classId=1580116519959474177&pageNum={}'
        }
    ]
