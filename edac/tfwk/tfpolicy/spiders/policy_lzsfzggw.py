...
class DataSpider(CrawlSpider):
    ...
    infoes = [
        {
            'url': 'https://fgw.luzhou.gov.cn/zwgk/lzyj/bmwj/wjfb',
            'label': "文件发布",
            'detail_xpath': '//ul[@class="newsList"]/li',
            'url_xpath': './a[contains(@href, "wjfb")]/@href',
            'title_xpath': './a[contains(@href, "wjfb")]/@title',
            'publish_time_xpath': './span[@class="date"]/text()',
            'body_xpath': '//div[@class="conTxt"]',
            'total': 4,
            'page': 1,
            'base_url': 'https://fgw.luzhou.gov.cn/zwgk/lzyj/bmwj/wjfb_{}'
        },
        {
            'url': 'https://fgw.luzhou.gov.cn/zwgk/lzyj/bmwj/zcjd',
            'label': "政策解读",
            'detail_xpath': '//ul[@class="newsList"]/li',
            'url_xpath': './a[contains(@href, "wjfb")]/@href',
            'title_xpath': './a[contains(@href, "wjfb")]/@title',
            ...
            'total': 3,
            'page': 1,
            'base_url': 'https://fgw.luzhou.gov.cn/zwgk/lzyj/bmwj/zcjd_{}'
        }
    ]
    ...
    def parse_detail(self, response):
        ...
        title = _meta.get('title') or \
                response.xpath('//meta[@name="ArticleTitle"]/@content').extract_first()
