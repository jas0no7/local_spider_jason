...
class DataSpider(CrawlSpider):
    ...
    infoes = [
        {
            'url': 'https://jxt.sc.gov.cn/scjxt/ggtz/common_list5.shtml',
            'label': "首页;政务公开;公告公示",
            'detail_xpath': '//ul[contains(@class, "list-li")]/li//h1[@class="f-20"]',
            'url_xpath': './/a/@href',
            'title_xpath': './/a/text()',
            ...
            'total': 67,
            'page': 1,
            'base_url': 'https://jxt.sc.gov.cn/scjxt/ggtz/common_list5_{}.shtml'
        },
        {
            'url': 'https://jxt.sc.gov.cn/scjxt/xzgfxwj/zcgfxwj_list.shtml',
            'label': "政策;行政法规文件",
            'detail_xpath': '//div[@class="biaobody"]/ul/li/div[@class="lie2"]',
            'url_xpath': './a/@href',
            'title_xpath': './a/@title',
            'publish_time_xpath': '',
            'body_xpath': '//div[@id="zoomcon"]',
        ...
        {
            'url': 'https://jxt.sc.gov.cn/scjxt/qtwj/zcgfxwj_list.shtml',
            'label': "政策;其他文件",
            'detail_xpath': '//div[@class="biaobody"]/ul/li/div[@class="lie2"]',
            'url_xpath': './a/@href',
            'title_xpath': './a/@title',
            ...
            'total': 18,
            'page': 1,
            'base_url': 'https://jxt.sc.gov.cn/scjxt/qtwj/zcgfxwj_list_{}.shtml'
        },
        {
            'url': 'https://jxt.sc.gov.cn/scjxt/zcjdn/common_listnb.shtml',
            'label': "首页;政务公开;政策解读",
            'detail_xpath': '//ul[contains(@class, "list-li")]/li//h1[@class="f-20"]',
            'url_xpath': './/a/@href',
            'title_xpath': './/a/@title',
            ...
            'total': 5,
            'page': 1,
            'base_url': 'https://jxt.sc.gov.cn/scjxt/zcjdn/common_listnb_{}.shtml'
        }
    ]
    ...
    def parse_detail(self, response):
        ...
        author = response.xpath('//meta[@name="Author"]/@content').extract_first() or \
                 ...
                 ''.join(re.findall(r'<div class="source fl">信息来源：(.*?)</div>', response.text, re.DOTALL)).strip()
