...
class DataSpider(CrawlSpider):
    ...
    infoes = [
        {
            'url': 'https://www.nanchong.gov.cn/fgw/zwxx/zcwj/xzgfxwj/',
            'label': "行政规范性文件",
            'detail_xpath': '//div[contains(@class, "xxgk-list2")]/ul/li',
            'url_xpath': './a/@href',
            'title_xpath': './a/text()',
            'publish_time_xpath': './span/text()',
            'body_xpath': '//div[@class="xl-article"]',
            'total': 1,
            'page': 1,
            'base_url': ''
        },
        {
            'url': 'https://www.nanchong.gov.cn/fgw/zwxx/zcwj/qtwj/',
            'label': "其他文件",
            'detail_xpath': '//div[contains(@class, "xxgk-list2")]/ul/li',
            'url_xpath': './a/@href',
            'title_xpath': './a/text()',
        ...
        {
            'url': 'https://www.nanchong.gov.cn/fgw/zwxx/zcjd/',
            'label': "政策解读",
            'detail_xpath': '//div[contains(@class, "xxgk-list2")]/ul/li',
            'url_xpath': './a/@href',
            'title_xpath': './a/text()',
