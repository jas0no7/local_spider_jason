...
class DataSpider(CrawlSpider):
    ...
    infoes = [
        {
            'url': 'https://sthjt.sc.gov.cn/sthjt/c103958/zfxxgk_gknrz.shtml',
            'label': "规划信息",
            'detail_xpath': '//*[@id="wzlm"]/dl/dd',
            'url_xpath': './a/@href',
            'title_xpath': './a/@title',
            'publish_time_xpath': './span[1]',
            'body_xpath': '//div[@class="xl_cont"] | //div[@class="content-zc"]',
            'total': 1,
            'page': 1,
            'base_url': 'https://sthjt.sc.gov.cn/sthjt/c103958/zfxxgk_gknrz.shtml'
        },
    ...
    def parse_detail(self, response):
        ...
        yield DataItem({
            ...
            'spider_topic': "spider-news-sichuan"
        })
