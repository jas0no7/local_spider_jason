...
class DataSpider(CrawlSpider):
    ...
    infoes = [
        {
            'url': 'https://gsb.nea.gov.cn/xxgk/zcfg/index.html',
            'label': "政策法规",
            ...
            'total': 7,
            'page': 1,
            'base_url': 'https://gsb.nea.gov.cn/xxgk/zcfg/index_{}.html'
        },
        {
            'url': 'https://gsb.nea.gov.cn/xxgk/zcjd/index.html',
            'label': "政策解读",
            'detail_xpath': '//ul[@class="wrapper_item_con4_ul"]/li/a',
            'url_xpath': './@href',
            'title_xpath': './span[1]/text()',
            ...
            'total': 6,
            'page': 1,
            'base_url': 'https://gsb.nea.gov.cn/xxgk/zcjd/index_{}.html'
        },
    ...
    def parse_detail(self, response):
        ...
        yield DataItem({
            ...
            'spider_topic': "spider-policy-gansu"
        })
