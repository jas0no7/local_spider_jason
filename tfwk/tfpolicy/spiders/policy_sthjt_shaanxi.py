...
class DataSpider(CrawlSpider):
    name = 'policy_sthjt_shaanxi'
    allowed_domains = [
        'sthjt.shaanxi.gov.cn'
    ]
    ...
    infoes = [
        {
            'url': 'https://sthjt.shaanxi.gov.cn/xxgk/fdnr/zcwj/shf/index.html',
            'label': "陕环发",
            ...
            'total': 12,
            'page': 1,
            'base_url': 'https://sthjt.shaanxi.gov.cn/xxgk/fdnr/zcwj/shf/index_{}.html'
        },
        {
            'url': 'https://sthjt.shaanxi.gov.cn/xxgk/fdnr/zcgh/index.html',
            'label': "政策规划",
            ...
            'total': 6,
            'page': 1,
            'base_url': 'https://sthjt.shaanxi.gov.cn/xxgk/fdnr/zcgh/index_{}.html'
        },
        {
            'url': 'https://sthjt.shaanxi.gov.cn/xxgk/fdnr/zcjd/index.html',
            'label': "政策解读",
            'detail_xpath': '//ul[@class="cm-news-list no-btop"]/li',
            'url_xpath': './a/@href',
            'title_xpath': './a/@title',
            ...
            'total': 24,
            'page': 1,
            'base_url': 'https://sthjt.shaanxi.gov.cn/xxgk/fdnr/zcjd/index_{}.html'
        }
    ...
    def parse_detail(self, response):
        ...
        yield DataItem({
            ...
            'spider_topic': "spider-policy-shaanxi"
        })
