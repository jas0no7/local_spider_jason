...
class DataSpider(CrawlSpider):
    ...
    infoes = [
        {
            'url': 'https://sthjj.cq.gov.cn/zwgk_249/zfxxgkml/zcjd/wzjd/index.html',
            'label': "文字解读",
            'detail_xpath': '//ul[@class="right-list"]/li',
            'url_xpath': './a/@href',
            'title_xpath': './a/@title',
            ...
            'total': 11,
            'page': 1,
            'base_url': 'https://sthjj.cq.gov.cn/zwgk_249/zfxxgkml/zcjd/wzjd/index_{}.html'
        },
    ...
    def parse_detail(self, response):
        ...
        yield DataItem({
            ...
            'spider_topic': "spider-policy-chongqing"
        })
