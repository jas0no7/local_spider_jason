...
class DataSpider(CrawlSpider):
    ...
    infoes = [
        {
            'url': 'https://fgw.hunan.gov.cn/fgw/jgzc11/newxxgklist.html',
            'label': "价格政策",
            'detail_xpath': '//div[@class="hy-list-text"]/ul/li/a',
            'url_xpath': './@href',
            'title_xpath': './@title',
            'publish_time_xpath': './small/text()',
            'body_xpath': '//div[@class="tys-main-zt"]',
            'total': 5,
            'page': 1,
            'base_url': 'https://fgw.hunan.gov.cn/fgw/jgzc11/newxxgklist_{}.html'
        },
        {
            'url': 'https://fgw.hunan.gov.cn/fgw/jggb11/newxxgklist.html',
            'label': "价格公布",
            'detail_xpath': '//div[@class="hy-list-text"]/ul/li/a',
            'url_xpath': './@href',
            'title_xpath': './@title',
            ...
            'total': 5,
            'page': 1,
            'base_url': 'https://fgw.hunan.gov.cn/fgw/jggb11/newxxgklist_{}.html'
        },
        {
            'url': 'https://fgw.hunan.gov.cn/fgw/xxgk_70899/zcfg/gjjfg/newxxgklist.html',
            'label': "政策法规;国家级法律法规",
            'detail_xpath': '//div[@class="hy-list-text"]/ul/li/a',
            'url_xpath': './@href',
            'title_xpath': './@title',
            ...
            'total': 5,
            'page': 1,
            'base_url': 'https://fgw.hunan.gov.cn/fgw/xxgk_70899/zcfg/gjjfg/newxxgklist_{}.html'
        },
        {
            'url': 'https://fgw.hunan.gov.cn/fgw/xxgk_70899/zcfg/dfxfg/newxxgklist.html',
            'label': "政策法规;地方性法规规章",
            'detail_xpath': '//div[@class="hy-list-text"]/ul/li/a',
            'url_xpath': './@href',
            'title_xpath': './@title',
            ...
            'total': 5,
            'page': 1,
            'base_url': 'https://fgw.hunan.gov.cn/fgw/xxgk_70899/zcfg/dfxfg/newxxgklist_{}.html'
        },
        {
            'url': 'https://fgw.hunan.gov.cn/fgw/xxgk_70899/zcfg/zcjd/newxxgklist.html',
            'label': "政策法规;政策解读",
            'detail_xpath': '//div[@class="hy-list-text"]/ul/li/a',
            'url_xpath': './@href',
            'title_xpath': './@title',
            ...
            'total': 5,
            'page': 1,
            'base_url': 'https://fgw.hunan.gov.cn/fgw/xxgk_70899/zcfg/zcjd/newxxgklist_{}.html'
        },
    ]
    ...
    def parse_detail(self, response):
        ...
        yield DataItem({
            ...
            'spider_topic': "spider-policy-hunan"
        })
