...
def build_cookies_from_412(response):
    ...
    js_url = "https://gxt.gansu.gov.cn" + js_src_list[0]
...
class DataSpider(CrawlSpider):
    name = "policy_gxt_gansu"
    allowed_domains = ["gxt.gansu.gov.cn"]
    ...
    infoes = [
        {
            "url": "https://gxt.gansu.gov.cn/common/search/24932f4d5c3a4dada3e739d18f6bd7ad",
            "label": "政策法规",
            "total": 100,
        },
        {
            "url": "https://gxt.gansu.gov.cn/common/search/c026a237135d4a5383c335f993f79925",
            "label": "经济运行",
            "total": 300,
        },
        {
            "url": "https://gxt.gansu.gov.cn/common/search/f862334c1ced4206968adfd3c122957f",
            "label": "政策解读",
            "total": 140,
        },
    ]
    ...
    def parse_list(self, response):
        ...
        for li in lis:
            ...
            if href.startswith("http://") or href.startswith("https://"):
                if not href.startswith("https://gxt.gansu.gov.cn/"):
                    logger.info(f"跳过站外链接: {href}")
                    continue
                detail_url = href
            else:
                detail_url = "https://gxt.gansu.gov.cn/" + href
    ...
    def parse_detail(self, response):
        ...
        body_xpath = (
            '('
            '//div[@class="gxtlmnew_main clearfix clear"]'
            ' | //div[@class="gxtnew_xxgk_main clearfix"]'
            ')'
        )
