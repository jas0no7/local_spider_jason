...
class DataSpider(CrawlSpider):
    ...
    infoes = [
        # {
        #     'url': 'https://jxt.sc.gov.cn/scjxt/xzgfxwj/zcgfxwj_list.shtml',
        #     'label': "行政规范文件",
        #     'detail_xpath': '//div[@class="biaobody"]/ul/li[1]',
        #     'url_xpath': './div[2]/a/@href',
        #     'title_xpath': './div[2]/a/@title',
        #     'publish_time_xpath': './div[5]',
        #     'body_xpath': '//div[@class="zfwjwzcontent"]',
        #     'total': 2,
        #     'page': 1,
        #     'base_url': 'https://jxt.sc.gov.cn/scjxt/xzgfxwj/zcgfxwj_list_{}.shtml'
        # },
        # {
        #     'url': 'https://jxt.sc.gov.cn/scjxt/gyyx1/common_list3.shtml',
        #     'label': "工业运行",
        #     'detail_xpath': '//h1[@class="f-20"]',
        #     'url_xpath': './div/a/@href',
        #     'title_xpath': './div/a/text()',
        #     'publish_time_xpath': './span/text()',
        #     'body_xpath': '//div[@class="cont_T"]',
        #     'total': 6,
        #     'page': 1,
        #     'base_url': 'https://jxt.sc.gov.cn/scjxt/gyyx1/common_list3_{}.shtml'
        # },
        {
            'url': 'https://jxt.sc.gov.cn/scjxt/gysjfb/common_list9.shtml',
            'label': "规模以上工业增长值",
            'detail_xpath': '//h1[@class="f-20"]',
            'url_xpath': './div/a/@href',
            'title_xpath': './div/a/text()',
            ...
            'total': 5,
            'page': 1,
            'base_url': 'https://jxt.sc.gov.cn/scjxt/gysjfb/common_list9_{}.shtml'
        },
        {
            'url': 'https://jxt.sc.gov.cn/scjxt/gmysgyqyjjxy/common_list9.shtml',
            'label': "规模以上企业经济效益",
            'detail_xpath': '//h1[@class="f-20"]',
            'url_xpath': './div/a/@href',
            'title_xpath': './div/a/text()',
            ...
            'total': 5,
            'page': 1,
            'base_url': 'https://jxt.sc.gov.cn/scjxt/gmysgyqyjjxy/common_list9_{}.shtml'
        },
