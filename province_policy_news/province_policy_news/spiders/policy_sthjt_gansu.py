...
class DataSpider(CrawlSpider):
    ...
    infoes = [
        {
            'url': 'https://125.74.7.101:50625/zfxxgk/zcwj1/gfxwj.htm',
            'label': "规范性文件",
            'detail_xpath': '//*[@id="line1060_0"]',
            'url_xpath': './a/@href',
            'title_xpath': './a/text()',
            'publish_time_xpath': './span/text()',
            'body_xpath': '//div[@class="mainside"]',
            'total': 3,
            'page': 1,
            'base_url': 'https://125.74.7.101:50625/zfxxgk/zcwj1/gfxwj/{}.htm'
        },
        {
            'url': 'https://125.74.7.101:50625/zfxxgk/zcwj1/zfwj.htm',
            'label': "政府文件",
            'detail_xpath': '//div[@class="gkmus2-1"]/ul/li',
            'url_xpath': './a/@href',
            'title_xpath': './a/text()',
            'publish_time_xpath': './span/text()',
            'body_xpath': '//div[@class="mainside"]',
            'total': 3,
            'page': 1,
            'base_url': 'https://125.74.7.101:50625/zfxxgk/zcwj1/zfwj/{}.htm'
        },
    ]
