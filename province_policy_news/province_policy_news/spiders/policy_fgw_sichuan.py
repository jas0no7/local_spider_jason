...
class DataSpider(CrawlSpider):
    ...
    infoes = [
        {
            'url': 'https://fgw.sc.gov.cn/sfgw/xzgfxwj/gfxwj_new.shtml',
            'label': "行政规范文件",
            'detail_xpath': '//div[@class="biaobody"]/ul/li',
            'url_xpath': './div[@class="lie2"]/a/@href',
            'title_xpath': './div[@class="lie2"]/a/@title',
            'publish_time_xpath': './div[@class="lie4"]/text()',
            'body_xpath': '//div[@class="zfwjwzcontent"]',
            'total': 5,
            'page': 1,
            'base_url': 'https://fgw.sc.gov.cn/sfgw/xzgfxwj/gfxwj_new_{}.shtml'
        },
        {
            'url': 'https://fgw.sc.gov.cn/sfgw/qtwj/qtwj_new.shtml',
            'label': "其他文件",
            'detail_xpath': '//div[@class="biaobody"]/ul/li',
            'url_xpath': './div[@class="lie2"]/a/@href',
            'title_xpath': './div[@class="lie2"]/a/@title',
            ...
            'total': 5,
            'page': 1,
            'base_url': 'https://fgw.sc.gov.cn/sfgw/qtwj/qtwj_new_{}.shtml'
        },
        {
            ...
            'total': 11,
            'page': 1,
            'base_url': 'https://fgw.sc.gov.cn/sfgw/nygy/common_list_{}.shtml'
        },
