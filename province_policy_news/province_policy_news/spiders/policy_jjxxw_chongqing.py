...
class DataSpider(CrawlSpider):
    ...
    infoes = [
        # {
        #     'url': 'https://jjxxw.cq.gov.cn/zwgk_213/zcwj/qtwj/index.html',
        #     'label': "行政规范文件",
        #     'detail_xpath': '//div[@class="item on"]/div[1]/a',
        #     'url_xpath': './@href',
        #     'title_xpath': './p/text()',
        #     'publish_time_xpath': './span/text()',
        #     'body_xpath': '//div[@class="yj3"]',
        #     'total': 82,
        #     'page': 1,
        #     'base_url': 'https://jjxxw.cq.gov.cn/zwgk_213/zcwj/qtwj/index_{}.html'
        # },
        # {
        #     'url': 'https://jjxxw.cq.gov.cn/zwgk_213/zcwj/qtwj/index.html',
        #     'label': "其他文件",
        ...
        # },
        # {
        #     'url': 'https://jjxxw.cq.gov.cn/ztzl_213/jjyx2/jjyx/index.html',
        #     'label': "经济运行",
        #     'detail_xpath': '//div[@class="li-8"]',
        #     'url_xpath': './a/@href',
        #     'title_xpath': '/a/p/text()',
        #     'publish_time_xpath': './a/span',
        #     'body_xpath': '//div[@class="yj2"]',
        #     'total': 27,
        #     'page': 1,
        #     'base_url': 'https://jjxxw.cq.gov.cn/ztzl_213/jjyx2/jjyx/index_{}.html'
        # },
        {
            'url': 'https://jjxxw.cq.gov.cn/ztzl_213/jjyx2/gyqst/index.html',
            'label': "工业趋势图",
            'detail_xpath': '//div[@class="li-8"]',
            'url_xpath': './a/@href',
            'title_xpath': './a/p/text()',
            'publish_time_xpath': './a/span',
            'body_xpath': '//div[@class="zwxl-content"] ',
            'total': 6,
            'page': 1,
            'base_url': 'https://jjxxw.cq.gov.cn/ztzl_213/jjyx2/gyqst/index_{}.html'
        },
        # {
        #     'url': 'https://jjxxw.cq.gov.cn/zwgk_213/zqgygk/',
        #     'label': "重庆工业概况",
        #     'detail_xpath': '//div[@class="li-8"]',
        #     'url_xpath': './a/@href',
        #     'title_xpath': '/a/p/text()',
        #     'publish_time_xpath': './a/span',
        #     'body_xpath': '//div[@class="zwxl-content"] | //div[@class="yj2"]',
        #     'total': 1,
        #     'page': 1,
        #     'base_url': 'https://jjxxw.cq.gov.cn/zwgk_213/zqgygk/'
        # },
    ...
    def parse_item(self, response):
        ...
        for ex_url in response.xpath(detail_xpath):
            ...
            meta = {
                ...
                "batch": self.dupefilter_field["batch"]  # 必须加
            }
