...
class DataSpider(CrawlSpider):
    ...
    infoes = [
        {
            'url': 'http://www.hnnyfz.org.cn/zcjd/index.html',
            'label': "政策解读",
            'detail_xpath': '//div[@class="newscontrb"]/ul/li/a',
            'url_xpath': './@href',
            'title_xpath': './span[1]',
            'publish_time_xpath': './span[2]',
            'body_xpath': '//div[@class="newscontr r"]',
            'total': 10,
            'page': 1,
            'base_url': 'http://www.hnnyfz.org.cn/zcjd/index_{}.html'
        },
