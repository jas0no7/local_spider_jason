...
class DataSpider(CrawlSpider):
    ...
    infoes = [
        {
            'url': 'https://fjb.nea.gov.cn/xxgk/zcfg/index.html',
            'label': "政策法规",
            'detail_xpath': '//ul[@class="wrapper_item_con4_ul"]/li/a',
            'url_xpath': './@href',
            'title_xpath': './span[1]',
            'publish_time_xpath': './span[2]',
            'body_xpath': '//div[@class="article-box"] | //div[@class="wrapper_deatil"] ',
            'total': 27,
            'page': 1,
            'base_url': 'https://fjb.nea.gov.cn/xxgk/zcfg/index_{}.html'
        },
        {
            'url': 'https://fjb.nea.gov.cn/xxgk/zcjd/index.html',
            'label': "政策解读",
            'detail_xpath': '//ul[@class="wrapper_item_con4_ul"]/li/a',
            'url_xpath': './@href',
            'title_xpath': './span[1]',
            ...
            'total':6,
            'page': 1,
            'base_url': 'https://fjb.nea.gov.cn/xxgk/zcjd/index_{}.html'
        },
