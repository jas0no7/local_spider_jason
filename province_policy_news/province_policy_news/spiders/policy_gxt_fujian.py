...
class DataSpider(CrawlSpider):
    ...
    infoes = [
        ...
        #     "chnlid": "32485",  # 接口内参数
        #     "max_page": 6,
        #     "referer": "https://gxt.fujian.gov.cn/zwgk/gysj/jjyxsj/",
        # },
        {
            "label": "工业投资行业数据",
            "chnlid": "38109",  # 接口内参数
            "max_page": 23,
            "referer": "https://gxt.fujian.gov.cn/zwgk/gysj/xysj/gytz/",
        },
        {
            "label": "信息产业行业数据",
            "chnlid": "38110",  # 接口内参数
            "max_page": 15,
            "referer": "https://gxt.fujian.gov.cn/zwgk/gysj/xysj/xxcy/",
        },
        {
            "label": "装备行业数据",
            "chnlid": "38112",  # 接口内参数
            "max_page": 15,
            "referer": "https://gxt.fujian.gov.cn/zwgk/gysj/xysj/zb/",
        },
        {
            "label": "消费品行业数据",
            "chnlid": "38113",  # 接口内参数
            "max_page": 14,
            "referer": "https://gxt.fujian.gov.cn/zwgk/gysj/xysj/xfp/",
        },
        {
            "label": "物流行业数据",
            "chnlid": "38114",  # 接口内参数
            "max_page": 12,
            "referer": "https://gxt.fujian.gov.cn/zwgk/gysj/xysj/wl/",
        },
        {
            "label": "其他行业数据",
            "chnlid": "38115",  # 接口内参数
            "max_page": 1,
            "referer": "https://gxt.fujian.gov.cn/zwgk/gysj/xysj/qt/",
        },
    ...
    # https://gxt.fujian.gov.cn/fjdzapp/search
